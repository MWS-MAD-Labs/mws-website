    ...
    <>
      ...
      <LevelPage
        ...
        tableRows={[
          [
            'Language',
            'Listening and early expression',
            'Stories, songs, conversation, and guided vocabulary routines',
          ],
          [
            'Inquiry',
            'Observation and wondering',
            'Hands-on provocations, nature walks, and simple projects',
          ],
          [
            'Wellbeing',
            'Security and independence',
            'Care rhythms, movement, rest, and social-emotional practice',
          ],
        ]}
        activities={[
          {
